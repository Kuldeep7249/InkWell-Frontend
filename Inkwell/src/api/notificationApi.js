...
export const notificationApi={
  ...
  unreadMine:()=>api.get(`${NOTIFICATIONS_BASE}/me/unread-count`,{silentErrors:true}),
  unreadByRecipient:id=>api.get(`${NOTIFICATIONS_BASE}/recipient/${id}/unread-count`,{silentErrors:true}),
  ...
  getMyUnreadCount:()=>api.get(`${NOTIFICATIONS_BASE}/me/unread-count`,{silentErrors:true}),
  getUnreadCount:id=>api.get(`${NOTIFICATIONS_BASE}/recipient/${id}/unread-count`,{silentErrors:true}),
